...
mpg %>% openxlsx::write.xlsx("data_output/mpg_dataset.xlsx")
```
...
mpg <- readxl::read_excel("data_output/mpg_dataset.xlsx")
```
...
mpg %>% 
  ...
  facet_wrap(~latex_drv, labeller = latex_labeller) +
